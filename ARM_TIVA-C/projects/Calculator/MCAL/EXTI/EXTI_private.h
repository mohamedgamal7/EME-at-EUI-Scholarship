...
#define IS_OFFSET       0x404u
#define IBE_OFFSET      0x408u
#define IEV_OFFSET      0x40Cu
#define IM_OFFSET       0x410u
#define MIS_OFFSET      0x418u
#define ICR_OFFSET      0x41Cu

/* NVIC Enable registers according to order of interrupts */
